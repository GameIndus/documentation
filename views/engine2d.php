<div class="row-container doc-container">
    ...
    <h3 class="subtitle" style="margin-top:-15px;font-size:1.2em">Si vous avez des problèmes concernant la création de
        votre jeu</h3>
   ...
   -->
    ...
    <div class="doc-content-container">
        ...
        <div class="doc-content doc-intro">
            <p>
                Créer un jeu peut s'avérer rapidement compliqué, surtout lorsque l'on débute dans le domaine. Mais il ne
                faut
                jamais décourager ! Dans cette partie de
                la documentation, nous allons tenter d'aborder tous les points nécessaires à la création de jeu en 2D
                grâce à
                notre moteur de jeu.<br>
                Si malgré cela des questions restent sans réponse, il est possible de faire appel à d'autres personnes
                pour
                avoir ce que l'on souhaite.<br>
                <b>Commençons.</b>
            </p>

            <blockquote>
                <p>
                    <i class="fa fa-info-circle"></i> Vous retrouverez dans cette partie de la documentation plusieurs
                    chapitres
                    sur des points particuliers
                    du fonctionnement de notre moteur de jeu. Si vous souhaitez ajouter des chapitres, n'hésitez pas à
                    nous
                    contacter via notre adresse e-mail.
                </p>
            </blockquote>
        </div>
