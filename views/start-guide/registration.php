...
?><div class="tutorial-container">
    ...
    <div class="tutorial-content">
        ...
        <ul>
            <li><b>1. Je ne reçois pas l'e-mail de confirmation</b> : dans ce cas-là, n'oubliez pas d'aller voir dans la boîte SPAM de votre boîte e-mail avant d'entamer toute procédure complémentaire. Si vous n'avez toujours pas l'e-mail 10 minutes après l'inscriptino sur notre site internet, ce dernier a peut-être un problème interne. Dans ce cas précis, il vous est possible de contacter un membre de l'équipe via un de nos réseaux sociaux, ou via notre adresse e-mail : <b>contact@gameindus.fr</b>. N'oubliez pas de lui préciser vos adresse e-mail, ainsi que votre pseudonyme utilisé lors de l'inscription.</li>
            <li></li><br>
